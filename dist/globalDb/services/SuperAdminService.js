...
class SuperAdminService {
    ...
    static findUserByLogin(login) {
        return __awaiter(this, void 0, void 0, function* () {
            return prisma_1.default.utilisateurs.findUnique({ where: { login } });
        });
    }
    static createUser(data) {
        return __awaiter(this, void 0, void 0, function* () {
            return prisma_1.default.utilisateurs.create({ data });
        });
    }
    ...
    static countNbCompanies() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield prisma_1.default.entreprises.count();
        });
    }
